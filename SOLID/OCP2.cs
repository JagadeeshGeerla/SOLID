...
namespace SOLID
{
   ...
   public abstract class DataProviderAbstract
    ...
    class SqlDataProvider : DataProviderAbstract
    {
    ...
    class OracleDataProvider : DataProviderAbstract
    {
        public override int OpenConnection()
        {
    ...
    class OledbDataProvider : DataProviderAbstract
    {
        public override int OpenConnection()
        {
    ...
    class OpenClosePrincipleDemo
    {
        public static void OSPDemo()
        {
            ...
            DataProviderAbstract DataProviderObject = new SqlDataProvider();
